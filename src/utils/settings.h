...
#define SETTINGS_GET(N)        (Settings::Get##N().ToString())
#define SETTINGS_GET_BOOL(N)   (Settings::Get##N().ToBool())
#define SETTINGS_GET_INT(N)    (Settings::Get##N().ToInt())
#define SETTINGS_GET_DOUBLE(N) (Settings::Get##N().ToDouble())
